...
void test7()
{
	PageId test_pageNo;
	Page* testPage;
	bufMgr->allocPage(file2ptr, test_pageNo, testPage);
	bufMgr->disposePage(file2ptr, test_pageNo);

	try{
		file2ptr->readPage(test_pageNo);
		PRINT_ERROR("ERROR :: Pages did not be disposed successfully.");
	} catch(InvalidPageException e){
